...
<head>
  ...
  <title>Investigation Reports</title>
...
<div class="wrapper">
  ...
  <nav id="sidebar" class="sidebar js-sidebar">
         <div class="mt-3">
          <a href="Page_No_10_Police_Dashboard.html" class="btn btn-secondary">	Back</a>
          </div>
    <div class="sidebar-content js-simplebar">
      <a class="sidebar-brand" href="Page_No_10_Police_Dashboard.html">
        <span class="align-middle">Police Dashboard</span>
      </a>

      <ul class="sidebar-nav">
        <li class="sidebar-header">Police</li>
        <li class="sidebar-item">
          <a class="sidebar-link" href="Page_No_8_View_Child_Reports_Police.jsp">
            <i class="align-middle" data-feather="eye"></i>
            <span class="align-middle">All Child Reports</span>
          </a>
        </li>
        <li class="sidebar-item active">
          <a class="sidebar-link" href="#">
            <i class="align-middle" data-feather="edit-3"></i>
            <span class="align-middle">Update Investigation Status</span>
          </a>
        </li>
      </ul>
    </div>
  ...
  <div class="main">
    <main class="content">
      <div class="container-fluid p-0">
        <h1 class="h3 mb-3">Investigation Status - Missing Child Reports</h1>
              ...
              <table class="table table-striped table-hover">
                ...
                %>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="Page_No_9_Update_Investigation_Status1.jsp?id=<%= rs.getInt("id") %>&Status=<%= rs.getString("status") %>"
